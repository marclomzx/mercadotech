> **Nota de contexto (Fase 7.5).** Este archivo es el **plan maestro del
> curso**: la planeación de las 8 sesiones con las que se construyó
> MercadoTech, tal como se escribió antes de empezar. Se conserva **intacto**
> —no se ha editado ni un párrafo— porque tiene valor propio como registro de
> lo que se planeó frente a lo que finalmente se construyó.
>
> Hasta la sesión 7 vivía en el `README.md` de la raíz del repositorio. Ahora
> **el README de la raíz es el del producto**: qué es MercadoTech, cómo
> levantarlo y cómo desplegarlo. Si buscas eso, ve a
> [`../../README.md`](../../README.md).
>
> Ojo al leer: donde el texto dice "este directorio", se refiere a la raíz del
> repositorio, que es donde vivía el archivo cuando se escribió.
